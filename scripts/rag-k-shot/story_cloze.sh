...
STORYCLOZE_VALID_PATH={YOUR_PATH}
STORYCLOZE_TEST_PATH={YOUR_PATH}
...
NUM_GPUS=${4:-"1"}
OUTPUT_FILE=${5:-"$OUTPUT_DIR/story_cloze.json"}

# task args
TYPE=${6:-"rag-token-k-shot"}
NUM_K=${7:-"5 10 70"}

DATASET_NAME=${8:-"story_cloze"}
SUBTASK_NAME=${9:-"2016"}

TRAIN_PATH=${10:-STORYCLOZE_VALID_PATH}
VALID_PATH=${11:-STORYCLOZE_TEST_PATH}
